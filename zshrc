...
# Paths added by pipx
export PATH="$PATH:/home/kolle/.local/bin:/home/kolle/bash_scripting"
...
# Custom aliases (override Oh My Zsh aliases here if needed)
alias bashconfig="nano ~/.zshrc"
alias ohmyzsh="nano ~/.oh-my-zsh"

# tmux aliases (retained)
alias tx="$HOME/.tmux_start.sh"
alias tks="tmux kill-session"
alias t="tmux a"
